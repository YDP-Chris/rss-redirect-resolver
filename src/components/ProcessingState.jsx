      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1">
            {isRssFeed ? (
              <Rss className="w-4 h-4 text-warning-500 bg-white rounded-full" />
            ) : (
              <Globe className="w-4 h-4 text-slate-500 bg-white rounded-full" />
            )}
          </div>
        </div>
        ...
        {/* Tips */}
        <div className="bg-primary-50 rounded-lg p-4 w-full max-w-md">
